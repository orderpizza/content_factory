...
class PackagedContractTests(unittest.TestCase):
    def test_built_wheel_initializes_without_checkout_resources(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            expected = sorted((ROOT / "docs/contracts").glob("application-schema.sql"))
...
from database.current import initialize_database, connect, validate_database, CONTRACT_PATH
