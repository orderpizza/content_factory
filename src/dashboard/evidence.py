...
def render_queue_status(connection):
    ...
    for table, label in [('intake_requests', 'Idea Intake'), ('determination_requests', 'Determination'), ('editorial_plan_runs', 'Editorial planning'), ('generation_runs', 'Generation'), ('visual_plan_runs', 'Visual planning'), ('storyboard_plan_runs', 'Storyboard planning'), ('render_runs', 'Rendering')]:
