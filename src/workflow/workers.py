...
class AdaptationWorker:
    ...
    def _process(self, run):
        ...
        public = content["hook"]
        package={"schema_version":"output_adaptation_v3","platform":output["platform"],"account":output["account"],"format":output["content_format"],"public_text":public,"caption":public,"hashtags":[],"private_tags":["fixture","placeholder"],"alt_text":content["context"],"claim_mappings":[],"visual_units":units,"visual_cues":[],"delivery_ready":False,"placeholder":True}
