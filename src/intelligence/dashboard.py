...
</head><body><h1>Content Factory Scout</h1><p>Latest Scout run: {escape(str(latest_run or 'not yet'))} | Observations: {observation_count} | Snapshots: {snapshot_count}</p><h2>Ranked Candidates</h2><table><tr><th>Stage</th><th>Topic</th><th>Score</th><th>Sources</th></tr>{candidate_rows}</table>
