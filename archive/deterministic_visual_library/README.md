...
it as a fallback. The active workflow uses only fixed Gemini domain profiles and
local post-image processing.

Restoring any material from this archive is a future product change: first define
an active contract, then add a deliberately scoped implementation and tests.
