...
**Registry version:** `contract_registry_v2`  
**Last architectural review:** 2026-09-08  
...
| `specs/data/records.md` | Exact detection SQLite | approved_for_implementation (detection slice only) | detection SQL/configuration | no |
| `specs/configuration.md` | Configuration | design_approved (v1 detection manifest unchanged) | domain/output registries, data/runtime/reliability | no |
...
| `specs/dashboard.md` | HAI | design_approved (current detection read model unchanged) | data, routing, production, runtime, posting | no |
